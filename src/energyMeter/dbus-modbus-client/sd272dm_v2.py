...
class SDM272DM_V2_Meter(device.EnergyMeter):
  ...
  def device_init(self):
    regs = [                                                               
            ...
            Reg_f32b(0x0000 + 4, '/Ac/L2/Voltage',  1, '%.1f V', rfc=4),  
            Reg_f32b(0x0006 + 4, '/Ac/L2/Current',  1, '%.1f A', rfc=4),  
            Reg_f32b(0x000c + 4, '/Ac/L2/Power',    1, '%.1f W', rfc=4),  
            ...
            Reg_f32b(0x0000 + 2, '/Ac/L3/Voltage',  1, '%.1f V', rfc=4),  
            Reg_f32b(0x0006 + 2, '/Ac/L3/Current',  1, '%.1f A', rfc=4),  
            Reg_f32b(0x000c + 2, '/Ac/L3/Power',    1, '%.1f W', rfc=4),  
